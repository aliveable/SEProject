            ...
            <form action="ReserveServlet" method="POST">
                <div class="container" style="margin-top: 2%;background: #D3D3D320;padding-top: 1%;margin-right: 1%" >
                    ...
                    <div class="row" style="margin-left: 1%"> 
                        ...
                        <div style="padding-left: 1%">
                            <input id="Day" class="form-control" name="date" type="text" placeholder="Day" data-provide="datepicker">
                        </div>
                ...
                <div class="container col-md-12" >
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-5" style="background: #D3D3D320">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    <select id="select_period" class="custom-select" name="select_period">
                    ...
                    <div class="row" style="background: #D3D3D320">
                        ...
                        <input id="cost" name="cost" type="hidden" value="${optional_price}">
