...
<html lang="en">
    ...
    <body>
        ...
        <br>
        <div class="container">
                <button id="addpackage" type="button" class="btn btn-success" style="margin-left: 2%">Create</button>
                <button id="addpackage" type="button" class="btn btn-danger" style="margin-left: 2%">Cancel</button>
        </div>
